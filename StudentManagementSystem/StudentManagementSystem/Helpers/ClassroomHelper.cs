...
public class ClassroomHelper
{
    ...
    public Classroom AskClassroom(string registerType)
    {
        ...
        if (registerType == "Teacher")
        {
            ...
            int idx = Helper.AskOption(classNames, "Hangi sınıfa eklensin?", "Yeni Sınıf Ekle");
            ...
            if (idx == 0)
            {
                ...
                idx = Helper.AskOption(classNames, "Hangi sınıfa eklensin?");
            }

            return classrooms[idx - 1];
        }
        ...
        int sIdx = Helper.AskOption(classNamesForStudent, "Hangi sınıfa eklensin?");
        return classrooms[sIdx - 1];
    }
